...
"""Defining and plotting a discrete-time version of the Lotka-Volterra model of population dynamics with a random gaussian fluctuation in resource's growth rate at each time step."""
