...
## Define the function
def dCR_dt(pops, t=0):
    """Discrete time version of the Lotka-Volterra model with density dependence."""
    R = pops[0]
    C = pops[1]
...
print('LV3.py execution time in seconds: ' + str(round(executionTime, 3)) + ".")

print(f"The resource density at the last timepoint in LV3 is {round(pops[9999,0], 3)}.")
print(f"The consumer density at the last timepoint in LV3 is {round(pops[9999,1], 3)}.")